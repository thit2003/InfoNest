...
// You can import your original register.css here if you copy it to src/styles/Register.css
// import '../styles/Register.css'; // Make sure you copy/adapt your register.css to src/styles/
  ...
  return (
    <div className="register-page-container" style={{
      ...
      <header className="header" style={{
        ...
        <h1 className="page-title" style={{ fontSize: '24px', fontWeight: 'bold', color: '#1a202c' }}>Register</h1>
      </header>
